...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void simpleNotification() {
        Person jd = new Person.Builder().setName("JournalDev ")
    ...
    private void notificationWithImage() {
        Person bot = new Person.Builder()
                .setName("Bot")
                .setIcon(IconCompat.createWithResource(this, R.drawable.img))
                .setImportant(true)
                .setBot(true) .build();
        Uri uri = Uri.parse("android.resource://com.journaldev.androidpnotifications/drawable/"+R.drawable.img);
